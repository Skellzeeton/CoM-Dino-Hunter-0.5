...
public class TUIPolygon : TUIControl
{
	...
	private void Draw()
	{
		...
		if (vertices != null)
		{
			...
			{
				float num3 = v1.angle % 360f;
				float num4 = v2.angle % 360f;
				if (num3 < 0f)
				{
					num3 += 360f;
				}
			...
			for (int num2 = 0; num2 < list3.Count - 1; num2++)
			{
				geometry.Triangles.Add(0);
				geometry.Triangles.Add(list3[num2] + 1);
				geometry.Triangles.Add(list3[num2 + 1] + 1);
			}
		}
