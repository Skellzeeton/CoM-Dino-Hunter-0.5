...
public class iAICenter
{
	...
	public bool Load()
	{
		...
		{
			if (!Utils.FileGetString("AI.xml", ref content))
			{
				return false;
			}
		}
		...
		{
			TextAsset textAsset = (TextAsset)Resources.Load(PrefabManager.GetPath(3000), typeof(TextAsset));
			if (textAsset == null)
			{
				return false;
			}
