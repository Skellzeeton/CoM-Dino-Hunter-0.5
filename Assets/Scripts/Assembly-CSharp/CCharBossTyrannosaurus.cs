...
public class CCharBossTyrannosaurus : CCharBoss
{
	...
	public override void InitAnimData()
	{
		...
		m_AnimData.Add(new CAnimInfo(kAnimEnum.Skill_Action_1, "idle"));
		m_AnimData.Add(new CAnimInfo(kAnimEnum.Skill_Action_2, "attack_bite01"));
		m_AnimData.Add(new CAnimInfo(kAnimEnum.Skill_Action_3, "attack03"));
		m_AnimData.Add(new CAnimInfo(kAnimEnum.Skill_Action_4, "attack02"));
	}
